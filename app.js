/* ==========================================
   MIM89 FAST FOOD - Core Engine & Real Firebase
   ========================================== */

// 1. مفاتيح الربط الخاصة بمشروع mim89-ff938
let db = null;
try {
    ...
    console.warn("جاري التشغيل على LocalStorage:", e);
}
...
/* ==========================================
   5. لوحة المخزن والإدارة المركزية
   ========================================== */
